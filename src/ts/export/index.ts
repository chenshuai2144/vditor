...
<script>
    ...
    Vditor.setContentTheme('${vditor.options.preview.theme.current}', '${
    vditor.options.preview.theme.path
  }');
    Vditor.codeRender(previewElement);
    Vditor.highlightRender(${JSON.stringify(vditor.options.preview.hljs)}, previewElement, '${
    vditor.options.cdn
  }');
...
<script src="${vditor.options.cdn}/dist/js/icons/${
    vditor.options.icon
  }.js"></script></body></html>`;

...
export class Headings extends MenuItem {
  ...
  constructor(vditor: IVditor, menuItem: IMenuItem) {
    ...
    panelElement.innerHTML = `<button data-tag="h1" data-value="# ">${
      window.VditorI18n.heading1
    } ${updateHotkeyTip('&lt;⌥⌘1>')}</button>
<button data-tag="h2" data-value="## ">${window.VditorI18n.heading2} &lt;${updateHotkeyTip(
      '⌥⌘2',
    )}></button>
<button data-tag="h3" data-value="### ">${window.VditorI18n.heading3} &lt;${updateHotkeyTip(
      '⌥⌘3',
    )}></button>
<button data-tag="h4" data-value="#### ">${window.VditorI18n.heading4} &lt;${updateHotkeyTip(
      '⌥⌘4',
    )}></button>
<button data-tag="h5" data-value="##### ">${window.VditorI18n.heading5} &lt;${updateHotkeyTip(
      '⌥⌘5',
    )}></button>
<button data-tag="h6" data-value="###### ">${window.VditorI18n.heading6} &lt;${updateHotkeyTip(
      '⌥⌘6',
    )}></button>`;

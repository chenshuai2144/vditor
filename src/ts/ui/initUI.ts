...
export const setPadding = (vditor: IVditor) => {
  ...
  if (vditor.wysiwyg.element.parentElement.style.display !== 'none') {
    const padding =
      (vditor.wysiwyg.element.parentElement.clientWidth - vditor.options.preview.maxWidth) / 2;
  ...
  if (vditor.ir.element.parentElement.style.display !== 'none') {
    const padding =
      (vditor.ir.element.parentElement.clientWidth - vditor.options.preview.maxWidth) / 2;

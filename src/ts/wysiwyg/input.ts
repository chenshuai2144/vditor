  ...
  if (
    ...
    if (!isWYSIWYGElement) {
      ...
      if (blockElement.tagName === 'UL' || blockElement.tagName === 'OL') {
        ...
        if (
          listPrevElement &&
          (listPrevElement.tagName === 'UL' || listPrevElement.tagName === 'OL')
        ) {
        ...
        if (
          listNextElement &&
          (listNextElement.tagName === 'UL' || listNextElement.tagName === 'OL')
        ) {
      ...
      if (footnoteElement) {
        ...
        if (footnoteItemElement) {
          const footnoteRefElement = vditor.wysiwyg.element.querySelector(
            `sup[data-type="footnotes-ref"][data-footnotes-label="${footnoteItemElement.getAttribute(
              'data-marker',
            )}"]`,
          );
